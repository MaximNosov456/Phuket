                ...
                for (
                  ...
                  if (void 0 !== document && "global" === c) {
                    ...
                    if (document.createEvent) {
                      ...
                      ((f = document.createEventObject()).eventType = s),
          ...
          var d = {
            ...
            inputFallBackEvent: function (e) {
              ...
              if (f !== c) {
                ...
                switch (
                  ((l.inputmask.shadowRoot || l.ownerDocument).activeElement !==
                    l && l.focus(),
            ...
            cutEvent: function (e) {
              ...
              window.navigator.clipboard
                ...
                l.handleRemove.call(t, a, r.default.DELETE, o),
                (0, s.writeBuffer)(
                  a,
                  n.getBuffer.call(t),
                  i.p,
          ...
          var s = {
            on: function (e, t, i) {
              ...
              ["submit", "reset"].includes(t)
                ? ((s = s.bind(e)), null !== e.form && l(e.form).on(t, s))
                : l(e).on(t, s),
              ...
              postValidation: function (e, t, i, a, n, r, o, s) {
                ...
                if (
                  ...
                  if (
                    ...
                    for (
                      var p = l.getMaskTemplate.call(this, !1, 1, void 0, !0),
                        h = t + 1;
                      h < e.length;
                      h++
                    )
                      ...
                      (m = (function (e, t, i) {
                        if (e.year !== e.rawyear) {
                          ...
                          if (2 === n.length && n === r) {
                            ...
                            e.day == l.getDate() &&
                              (!i.max || i.max.date.getTime() >= l.getTime()) &&
          ...
          a.default.extendAliases({
            numeric: {
              ...
              onKeyDown: function (e, t, i, a) {
                ...
                if ((o = a.shortcuts && a.shortcuts[u]) && o.length > 1)
                  return (
                ...
                if (
                  ...
                  if (
                    ...
                    return (
                      ...
                      l.trigger("setvalue", [r.join(""), i.begin]),
                      !1
                    );
                  if (!0 === a._radixDance) {
                    ...
                    if (a.digitsOptional) {
                      ...
                      (i.begin < f ||
                        i.end < f ||
                        (e.keyCode === n.default.DELETE && i.begin === f))
                    )
                      return (
                        i.begin !== i.end ||
                          (e.keyCode !== n.default.BACKSPACE &&
        ...
        7760: function (e, t, i) {
          ...
          function d(e, t, i, a, n) {
            ...
            if (
                ...
                if (void 0 !== e) {
                  ...
                  !(function (e, t) {
                    ...
                    var n =
                      0 === a &&
                      !o.isMask.call(s, e) &&
                      (r.getTest.call(s, e).match.nativeDef === t.charAt(0) ||
                        ...
                        (" " === r.getTest.call(s, e).match.nativeDef &&
                          (r.getTest.call(s, e + 1).match.nativeDef ===
                            t.charAt(0) ||
                            (!0 === r.getTest.call(s, e + 1).match.static &&
                              r.getTest.call(s, e + 1).match.nativeDef ===
                                "'" + t.charAt(0)))));
              ...
              if (
                (!l.isComplete.call(s, o.getBuffer.call(s)) && y.length <= E) ||
                ...
                for (var S = E; void 0 !== (x = y.shift()); ) {
                  ...
                  if (
                    ...
                    (_.keyCode = P.input.charCodeAt(0)),
                    (g = u.EventHandlers.keypressEvent.call(
                      s,
                      _,
                      !0,
              ...
              (e.inputmask.skipInputEvent = !0),
                ...
                setTimeout(function () {
                  h === o.getBufferTemplate.call(s).join("")
                    ? p.trigger("cleared")
                    : !0 === l.isComplete.call(s, t) && p.trigger("complete");
                }, 0);
            }
          }
        },
        2394: function (e, t, i) {
          ...
          (y.prototype = {
            ...
            isValid: function (e) {
              ...
              for (
                var i = s.getBuffer.call(this),
                  a = s.determineLastRequiredPosition.call(this),
                  n = i.length - 1;
                n > a && !s.isMask.call(this, n);
                n--
              );
              return (
                i.splice(a, n + 1 - a),
              ...
              if (!1 !== f) {
                (e.originalPlaceholder = i.placeholder),
                  ...
                  !0 === f &&
                    ...
                    l.EventRuler.on(i, "submit", c.EventHandlers.submitEvent),
                    l.EventRuler.on(i, "reset", c.EventHandlers.resetEvent),
                    l.EventRuler.on(i, "blur", c.EventHandlers.blurEvent),
                    l.EventRuler.on(i, "focus", c.EventHandlers.focusEvent),
                    l.EventRuler.on(i, "invalid", c.EventHandlers.invalidEvent),
                    l.EventRuler.on(i, "click", c.EventHandlers.clickEvent),
                    l.EventRuler.on(
                      i,
                      "mouseleave",
                    ...
                    l.EventRuler.on(i, "paste", c.EventHandlers.pasteEvent),
                    l.EventRuler.on(i, "cut", c.EventHandlers.cutEvent),
                    l.EventRuler.on(i, "complete", t.oncomplete),
                    l.EventRuler.on(i, "incomplete", t.onincomplete),
                    l.EventRuler.on(i, "cleared", t.oncleared),
                    !0 !== t.inputEventOnly &&
                      (l.EventRuler.on(
                        i,
                        "keydown",
                      ...
                      l.EventRuler.on(i, "keyup", c.EventHandlers.keyupEvent)),
                  ...
                  l.EventRuler.on(i, "setvalue", c.EventHandlers.setValueEvent),
              ...
              if (e.begin === e.end) {
                switch ((i = i || c.positionCaretOnClick)) {
                  ...
                  default:
                    ...
                    if (d <= h)
                      e.end = e.begin = l.call(n, d, !1, !0) ? d : s.call(n, d);
                    else {
                      ...
                      if (
                        ...
                        (!l.call(n, h, c.keepStatic, !0) && m.match.def === g)
                      ) {
                        var k = s.call(n, h);
                        (d >= k || d === h) && (h = k);
                      }
              ...
              do {
                if (!0 === e && c.validPositions[k])
                  ...
                  ("number" == typeof y && isFinite(y) && y > k)
                    ? g.push(!1 === i ? h.nativeDef : l.call(r, k, h))
                    : (m = !1);
                }
                k++;
                ...
                if (o.length > 1 + ("" === o[o.length - 1].match.def ? 1 : 0))
                  for (var s = 0; s < o.length; s++)
                    if (
                      ...
                      (!0 === o[s].match.static ||
                        void 0 === r ||
                        !1 !== o[s].match.fn.test(r.match.def, n, e, !0, a)) &&
                      (l.push(o[s]),
          ...
          function d(e, t, i) {
            ...
            function y(t, i, r, o) {
              function l(r, o, u) {
                ...
                if (h === e && void 0 === r.matches) {
                  ...
                  if (r.isGroup && u !== r) {
                    if ((r = l(t.matches[t.matches.indexOf(r) + 1], o, u)))
                      return !0;
                    ...
                    if (-1 === C || "string" == typeof C) {
                      ...
                      for (var N = 0; N < B.length; N++) {
                        (A = parseInt(B[N])),
                          (m = []),
                          (i =
                            ("string" == typeof C && v(h, A, O)) || j.slice());
                        var V = _.matches[A];
                        if (V && l(V, [A].concat(o), u)) r = !0;
                        else if (
                          (0 === N && (T = !0),
                          V &&
                            V.matches &&
                            V.matches.length > _.matches[0].matches.length)
                        )
                          break;
                        (S = m.slice()), (h = D), (m = []);
                          ...
                          for (var U = 0; U < w.length; U++) {
                            ...
                            if (
                              ...
                              if (
                                ...
                                !0 === (Q = H).match.static &&
                                  !0 !== Z.match.static &&
                                  Z.match.fn.test(Q.match.def, s, e, !1, c, !1))
                              ) {
                                x(H, $) ||
                      ...
                      r = l(_.matches[C] || t.matches[C], [C].concat(o), u);
                    if (r) return !0;
                  } else if (
                    r.isQuantifier &&
                    ...
                    for (
                      ...
                      if ((r = l(W, [z].concat(o), W))) {
                        ...
                        return (
                          a.jit &&
                            (s.jitOffset[e] =
                              W.matches.length - W.matches.indexOf(a)),
                          !0
                        );
                      }
                    }
            ...
            if (e > -1) {
              if (void 0 === t) {
                for (
                  var b, x = e - 1;
                  void 0 === (b = s.validPositions[x] || s.tests[x]) && x > -1;
        ...
        7215: function (e, t, i) {
          ...
          function d(e, t, i, a, r, l, p) {
            ...
            function E(t, i, r) {
              var l = !1;
              return (
                n.getTests.call(g, t).every(function (s, c) {
                  var d = s.match;
                  if (
            ...
            if (
              ...
              for (var w = x; w < (g.isRTL ? e.begin : e.end); w++)
                void 0 !== b.excludes[w] &&
                  ((b.excludes[w] = void 0), delete b.tests[w]);
            if (
                ...
                if (
                  ...
                  if (
                    ...
                    if (
                      ...
                      for (
                        var T = x + 1, C = o.seekNext.call(g, x, !1, 0 !== x);
                        T <= C;
                        T++
                      )
                        if (!1 !== (S = E(T, t, i))) {
          ...
          function p(e, t, i) {
            for (
              var a = this.maskset, r = !1, o = n.getTests.call(this, e), l = 0;
              l < o.length;
              l++
            ) {
              if (
              ...
              if (void 0 === r.validPositions[s] && !o.isMask.call(a, s, !1))
                if (0 == s ? n.getTest.call(a, s) : r.validPositions[s - 1]) {
                  ...
                  if (
                    ...
                    (((f = l.extend({}, f, {
                      input:
                        n.getPlaceholder.call(a, s, f.match, !0) || f.match.def,
                    })).generatedInput = !0),
                    m.call(a, s, f, !0),
                    !0 !== i)
                  ) {
          ...
          function m(e, t, i, a) {
            ...
            if (
              ...
              var b,
                ...
                E = P;
              for (
                t && ((l.validPositions[a] = u.extend(!0, {}, t)), E++, P++),
                  g = t ? v : v - 1;
                g <= y;
                g++
              ) {
              ...
              t &&
                ...
                (l.validPositions[a] = u.extend(!0, {}, t));
